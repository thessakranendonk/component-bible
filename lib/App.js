...
var App = function () {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", __assign({ className: (0, clsx_1.default)(isSidePanelVisible
            ...
            : 'transition transform ease-in-out duration-500 delay-100 translate-x-0') }, { children: [(0, jsx_runtime_1.jsx)(components_1.IconHeader, { companyName: "Hello", logo: logo, navigationLinks: navigationLinks, iconNavBarItems: iconNavBarItems, headerBgColor: "bg-white", dropdownBgColor: "bg-yellow-900", dropdownBorderColor: "border-red-900", dropdownTextColor: "text-red-900", textClassName: "font-serif", linkClassName: "text-black text-md font-normal font-serif", logoClassName: "h-20 mt-6 pl-8 lg:h-24 lg:pl-32 lg:mt-4", hoverClassName: "hover:text-yellow-400", activeLinkClassName: "text-red-900 font-serif", currentActiveLocation: location.pathname, onMenuOpen: openSidePanel, onMenuClose: closeSidePanel, isPanelOpen: isSidePanelVisible }), (0, jsx_runtime_1.jsx)(components_1.HeroOne, { image: "https://images.unsplash.com/photo-1491895200222-0fc4a4c35e18?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2874&q=80", location: "Bloor West Village", locationClassName: "text-xl lg:text-3xl font-semibold mb-4 font-serif", companyName: "Runnymede Medical Clinic", companyNameClassName: "text-4xl lg:text-7xl font-semibold font-serif", infoText: "Dr. & Associates are currently accepting new patients", infoTextClassName: "mt-3 lg:my-4 lg:text-xl font-serif", contactButtonText: "Call: 519-861-4813", contactButtonClassName: "bg-red-900 text-white px-8 py-3 lg:py-4  mt-10 lg:mt-2 rounded-md font-serif", buttonLink: "/" }), (0, jsx_runtime_1.jsx)(components_1.HeroInfoBar, { heroImageRowItemsClassName: "bg-red-900 text-white font-serif", heroImageBarItems: heroImageBarItems }), (0, jsx_runtime_1.jsx)("div", __assign({ className: "py-24" }, { children: "hello" })), (0, jsx_runtime_1.jsxs)("div", __assign({ className: "static flex mx-auto justify-center bg-red-900 w-mapXLBg h-fit p-8" }, { children: [(0, jsx_runtime_1.jsx)("div", __assign({ className: "flex justify-start w-full" }, { children: (0, jsx_runtime_1.jsx)(components_1.MapInfoSidePanel, { mapContactInfo: contact, businessHours: hours, textClassName: "font-serif", h2ClassName: "font-semibold font-serif text-2xl", isMapInfoPanelOpen: isMapSidePanelVisible, panelButtonClassName: "bg-red-900", onMapOpen: openMapSidePanel, onMapClose: closeMapSidePanel }) })), (0, jsx_runtime_1.jsx)(components_1.LocationMap, { mapLocationDetails: locationsList, mapCenter: [43.65102, -79.47588], zoomNumber: 16, mapClassName: "absolute inset-x-center m-auto", mapSize: "w-mapXL h-mapSidePanelXL" })] }))] })));
};
exports.default = App;
